                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr style="background-color: whitesmoke">
                            <td style="padding: 30px 40px 30px 40px; text-align: center;">
                                <img src="https://scpn.ecuacoders.com/images/logo.png" alt="logo scpn" width="200" height="100"
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td valign="top"
                                                ...
                                                <p style="margin: 0;">
                                                    Somos fieles guardianes del orden, defendemos la paz, la justicia;
                                                    de la ley somos fuerte milicia que asegura al país libertad.
                                                    Inflamados de amor a la
                                                    Patria, tremolando sin mancha su emblema, viviremos con fe nuestro
                                                    lema:
...
{{--                                    YOU'VE BEEN INVITED TO THIS YEARS EVENT</h1>--}}
{{--                            </td>--}}
{{--                        </tr>--}}
                        <tr>
                            <td style="padding: 0px 40px 20px 40px; font-family: sans-serif; font-size: 14px; line-height: 20px; color: #555555; text-align: left; font-weight:normal;">
                                <p style="margin: 24px 0;">
                                    El Servicio de Cesantía de la Policía Nacional le
                                    hace la coordial invitación
                                    al evento que se realizará el XX de XX del 2021 en XXXXX. Para confirmar la
                                    asistencia
                                    a dicho evento debe ingresar a nuestro sitio web dando click en el boton que se
                                    encuentra debajo.
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 0px 40px 20px 40px; font-family: sans-serif; font-size: 14px; line-height: 20px; color: #555555; text-align: left; font-weight:normal;">
                                <p style="margin: 12px 0; font-weight: bold">Datos de usuario para ingresar al sistema,</p>
                                <p style="margin: 14px 0;"><span
                                        style="font-weight: bold">Usuario: </span> {{ $invitacion->cedula }}</p>
                                <p style="margin: 0;"><span
                                        style="font-weight: bold">Contraseña: </span>{{ $invitacion->cedula }}</p>
                            </td>
                        </tr>
                                    ...
                                    <table role="presentation" align="center" cellspacing="0"
                                        ...
                                        <tr>
                                            <td style="border-radius: 50px; background: #0159B7; text-align: center;"
                                                class="button-td">
                                                <a href="{{ route('front.invitacion.confirm', $invitacion->codigo_invitacion)  }}"
                                                   ...
                                                   class="button-a">
                                                    <span style="color:#ffffff;" class="button-link">&nbsp;&nbsp;&nbsp;&nbsp;Confirmar asistencia&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
